...
UUID = os.environ.get('UUID', 'c48ff415-94e7-44f3-b3fb-6de914462a32')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'v1.wbxl.dpdns.org:10024')      # 哪吒面板域名或ip, v1格式: nezha.xxx.com:8008, v0格式: nezha.xxx.com
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'altr.wbxl00.ggff.net')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNTI2NjQ3MGU5ZmZiZmYwMWU1ZmI5Yzk1NjExNjZhZmYiLCJ0IjoiZDcxYWViYWMtOWE1ZC00ZGJhLWFlN2MtMzY4M2Q4MDg2YzM2IiwicyI6IllXSm1PR0kzWkRjdE5UazVNaTAwWWpRd0xXSmtPVGN0TXpJNU1tRTBPRE0zWWpobCJ9')            # Argo固定隧道密钥,留空即使用临时隧道
...
NAME = os.environ.get('NAME', 'altr1')                      # 节点名称
